...
#define type_hasptr_to(type_) type_isptr(type_) || type_isfunc(type_) || type_isarray(type_)
...
#define tpmodel_new(bname,blen,kind) tpmodel_tnew(typemgr_find(bname,blen,kind))
...
void typemgr_regalias(char *alname,int allen,bool isStUni,char *base,int baselen);
